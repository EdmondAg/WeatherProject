...
public class OpenWeatherService {
    static final String URL1 =
            "https://api.open-meteo.com/v1/forecast?latitude=41.33&longitude=19.78&hourly=temperature_2m,relativehumidity_2m,visibility,windspeed_10m,soil_moisture_0_1cm&models=best_match&start_date=2022-06-08&end_date=2023-01-12";
...
//        callList();
    ...
    private static void callString() {
        try {
            ...
            FileManager.saveFile(dataString, "OpenWeatherString.txt");
