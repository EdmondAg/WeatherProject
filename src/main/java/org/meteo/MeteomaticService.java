...
import org.meteo.http.MeteomaticsAPI;

public class MeteomaticService {
    static MeteomaticsAPI meteomaticsAPI = new MeteomaticsAPI();
    ...
    static final String METEOMATICS_2_HOUR_INTERVAL = "https://api.meteomatics.com/2022-12-20T16:20:00.000+01:00--2022-12-31T16:20:00.000+01:00:PT1H/t_mean_1000m_2h:C/51.5073219,-0.1276474/json?model=mix";
    public static void main(String[] args) throws Exception {
        System.out.println(readFromFile("MeteomaticsExample.txt"));
        System.out.println(readFromFile("Open_weather_API.txt"));

        meteomaticsAPI.callURL(METEOMATICS_2_HOUR_INTERVAL);
        System.out.println(meteomaticsAPI.getData());
    }
